...
class MainPage(Frame):
    def __init__(self, master):
        ...
        self.title_label = Label(self.master, font=("Helvetica", 16),
                                 text="THE CINEMAS Welcomes You!! Please select whether"
...
class Customer(MainPage):
    def __init__(self, master):
        ...
        self.title = Label(self.master, font=("Helvetica", 16), text='enter your username and password')
    ...
    def login(self):
        ...
        if login1:
            ...
            self.master.withdraw()
            tkinter.messagebox.showinfo("-- COMPLETE --", "Logged In.", icon="info")
        else:
...
class CustMain(Customer):
    def __init__(self, master):
        ...
        self.defdate1.set("Monday 15/02/21")  
        self.datelist1 = OptionMenu(master, self.defdate1, "Monday 15/02/21", "Tuesday 16/02/21", "Wednesday 17/02/21",
                                    "Thursday 18/02/21", "Friday 19/02/21", "Saturday 20/02/21", "Sunday 21/02/21")
        self.datelist1.pack()
...
class SearchResults(CustMain):
    ...
    def boo(self, gone, datetime7):
        ...
        if msg:
            ...
            alr = c3.fetchone()
            if alr:
                tkinter.messagebox.showinfo("---- ERROR ----", "You are already booked this film", icon="warning")
            elif self.gone == 100:
                tkinter.messagebox.showinfo("---- ERROR ----", "House full", icon="warning")
            else:
                with conn2:
                ...
                # if td_year > 2021 or \
                #         td_year == 2021 and td_month > 1 or \
                #         td_year == 2021 and td_month == 1 and td_day > new_date or \
                #         td_year == 2021 and td_month == 1 and td_day == new_date and td_hour >= new_time:
    ...
    def change(self):
        ...
        if msg:
            ...
            try:
                ...
                tkinter.messagebox.showinfo("---- ERROR ----", "Please fill all the cells.", icon="warning")
            except InvalidEmailError:
                tkinter.messagebox.showinfo("---- ERROR ----", "Invalid email format!", icon="warning")
            except PasswordsDoNotMatchError:
                tkinter.messagebox.showinfo("---- ERROR ----", "Passwords does not match!", icon="warning")
            except ValueError:
...
class BookHist(Booked):
    def __init__(self, master):
        ...
        c3.execute('''SELECT date, time, seatno FROM bookings WHERE
                    username = ? ORDER BY date='Monday 15/02/21' DESC,
                                                    date='Tuesday 16/02/21' DESC,
                                                    date='Wednesday 17/02/21' DESC,
                                                    date='Thursday 18/02/21' DESC,
                                                    date='Friday 19/02/21' DESC,
                                                    date='Saturday 20/02/21' DESC,
                                                    date='Sunday 21/02/21' DESC,
                                                    time='1pm' DESC,
                                                    time='2pm' DESC,
                                                    time='3pm' DESC,
                                                    time='4pm' DESC,
...
class Showings(EmployeeMain):
    def __init__(self, master):
        ...
        self.seeseats = Label(self.master, text='Seating', font=("Helvetica", 16), width=8).grid(row=0, column=7,
                                                                                                 pady='1')
        c2.execute('''SELECT * FROM movies ORDER BY 'Monday 15/02/21' DESC,
                                                    date='Tuesday 16/02/21' DESC,
                                                    date='Wednesday 17/02/21' DESC,
                                                    date='Thursday 18/02/21' DESC,
                                                    date='Friday 19/02/21' DESC,
    ...
    def export(self):
        try:
            ...
            c2.execute('''SELECT * FROM movies ORDER BY date='Monday 15/02/21' DESC,
                                                    date='Tuesday 16/02/21' DESC,
                                                    date='Wednesday 17/02/21' DESC,
                                                    date='Thursday 18/02/21' DESC,
                                                    date='Friday 19/02/21' DESC,
...
class AddShowings(Showings):
    def __init__(self, master):
        ...
        self.defdate.set("Monday 15/02/21")  
        self.datelist = OptionMenu(master, self.defdate, "Monday 15/02/21", "Tuesday 16/02/21", "Wednesday 17/02/21",
                                    "Thursday 18/02/21", "Friday 19/02/21", "Saturday 20/02/21", "Sunday 21/02/21")
